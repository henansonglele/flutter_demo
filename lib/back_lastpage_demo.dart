...
void main() {
  runApp(new MaterialApp(
    ...
    home: new BackDemoHomeScreen(),
  ));
}

class BackDemoHomeScreen extends StatelessWidget {
  @override
            ...
            new Padding(
              ...
              child: new RaisedButton(
                onPressed: () {
                  ...
                  Navigator.pop(context, 'you clicked Yep!');
                },
                child: new Text('Yep!'),
              ),
            ),
            new Padding(
              ...
              child: new RaisedButton(
                onPressed: () {
                  ...
                  Navigator.pop(context, 'you clicked Nope!');
                },
                child: new Text('Nope!'),
              ),
            )
