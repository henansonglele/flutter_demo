...
class MyMultiLayout extends StatelessWidget {
  @override
...
class LayoutDemo extends MultiChildRenderObjectWidget {
  LayoutDemo({Key key, List<Widget> children})
  ...
  void updateRenderObject(BuildContext context, RenderLayout renderObject) {
    //updateRenderObject则只是修改 原来renderObject  对象的属性.
...
class RenderLayout extends RenderBox
    with
        ContainerRenderObjectMixin<RenderBox, PageParentData>,
        RenderBoxContainerDefaultsMixin<RenderBox, PageParentData> {
  Paint _paint;
