...
//  viewportFraction: 1.0 //默认1，每个页面占可视窗的比例
  ...
  final List<Widget> _pages = <Widget>[
    new Container(
        ...
        child: Container(
          color: Colors.redAccent,
          margin: EdgeInsets.all(selectIndex==0?20:0),
          child:
          new Center(child:
...
//    ),
    new Container(
      ...
      child: Container(
        color: Colors.redAccent,
        margin: EdgeInsets.all(selectIndex==1?20:0),
        child:
        new Center(child:
        new Text("page 2",style : new TextStyle(
          fontSize:20,
          color: Colors.black,
        )),
        )
...
//    ),
    new Container(
      ...
      child: Container(
        color: Colors.redAccent,
        margin: EdgeInsets.all(selectIndex==2?20:0),
        child:
        new Center(child:
...
//    ),
    new Container(
      ...
      child: Container(
        color: Colors.redAccent,
        margin: EdgeInsets.all(selectIndex==3?20:0),
        child:
        new Center(child:
        new Text("page 4",style : new TextStyle(
          fontSize:20,
          color: Colors.black,
        )),
        )
    ...
    new Container(
        ...
        color: Colors.amber,
        child: new Center(child:
        new Text("page 6",style : new TextStyle(
          fontSize:20,
          color: Colors.white,
        )),
        )
    ...
    new Container(
        ...
        color: Colors.lightGreen,
        child: new Center(child:
        new Text("page 7",style : new TextStyle(
          fontSize:20,
          color: Colors.white,
        )),
        )
